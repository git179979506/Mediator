...
open class BaseCardCell: BaseCell {
    
    public var cornerStyle: BaseCardView.CornerStyle = .none {
        didSet {
    ...
    public var edgeInset = UIEdgeInsets(top: 0, left: 16, bottom: 0, right: 16) {
        didSet {
    ...
    public lazy var cardView = BaseCardView()
}
